...
import {Player} from "@/app/lib/objects/townSearchObjects";
import {X2jOptions, XMLParser} from "fast-xml-parser";
import {CORS_ILLYRIAD_PLAYERS_DATA_FILE} from "@/app/lib/constants/townSearchConstants";
...
onmessage = async (e: MessageEvent<null>): Promise<void> => {
  ...
  const url = CORS_ILLYRIAD_PLAYERS_DATA_FILE;
